...
#     print(measurement)
#     db_waist = db.query(MaleMeasurement.waist).filter(MaleMeasurement.height == measurement.height,MaleMeasurement.weight == measurement.weight, MaleMeasurement.age == measurement.age).first()
#     if db_waist :
...
#         db_waist = db.query(MaleMeasurement.waist).filter(MaleMeasurement.height == measurement.height,MaleMeasurement.weight == measurement.weight, MaleMeasurement.age == measurement.age).first()
#         if db_waist:
#             db.query(MaleMeasurement).filter(MaleMeasurement.height == measurement.height,MaleMeasurement.weight == measurement.weight, MaleMeasurement.age == measurement.age).update({"waist" : measurement.waist})
#         else:
